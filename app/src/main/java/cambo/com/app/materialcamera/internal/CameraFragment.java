...
import cambo.com.app.materialcamera.util.Degrees;
import cambo.com.app.materialcamera.util.ImageUtil;
import cambo.com.app.materialcamera.util.ManufacturerUtil;

import static cambo.com.app.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_BACK;
import static cambo.com.app.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_FRONT;
import static cambo.com.app.materialcamera.internal.BaseCaptureActivity.CAMERA_POSITION_UNKNOWN;
import static cambo.com.app.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_ALWAYS_ON;
import static cambo.com.app.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_AUTO;
import static cambo.com.app.materialcamera.internal.BaseCaptureActivity.FLASH_MODE_OFF;
...
public class CameraFragment extends BaseCameraFragment implements View.OnClickListener {
  ...
  cambo.com.app.materialcamera.internal.CameraPreview mPreviewView;
...
//      Log.d(TAG, "openCamera: height: " + height);
  ...
  private void createPreview() {
    ...
    if (mWindowSize == null) mWindowSize = new Point();
    activity.getWindowManager().getDefaultDisplay().getSize(mWindowSize);
    mPreviewView = new cambo.com.app.materialcamera.internal.CameraPreview(getActivity(), mCamera);
    if (mPreviewFrame.getChildCount() > 0 && mPreviewFrame.getChildAt(0) instanceof cambo.com.app.materialcamera.internal.CameraPreview)
